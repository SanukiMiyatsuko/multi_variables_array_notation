        ...
        {showHide && (
          <ul>
            <li><label className="checkbox">
              ...
              &nbsp;{options.checkOnOffp ? "ψ" : selected}(0,0,...,0,0,1)をωで出力
            </label></li>
            <li><label className="checkbox">
              <input type="checkbox" checked={options.checkOnOffO} onChange={() => handleCheckboxChange('checkOnOffO')} />
              &nbsp;{options.checkOnOffp ? "ψ" : selected}(0,0,...,0,1,0)をΩで出力
            </label></li>
            <li><label className="checkbox">
              <input type="checkbox" checked={options.checkOnOffI} onChange={() => handleCheckboxChange('checkOnOffI')} />
              &nbsp;{options.checkOnOffp ? "ψ" : selected}(0,0,...,1,0,0)をIで出力
            </label></li>
            <li><label className="checkbox">
            ...
            <li><label className="checkbox">
              ...
              &nbsp;{options.checkOnOffp ? "ψ" : selected}(a_n,a_&#123;n-1&#125;,...,a_3,a_2,a_1)を{options.checkOnOffp ? "ψ" : selected}_&#123;a_n&#125;(a_n,a_&#123;n-1&#125;,...,a_3,a_2,a_1)で表示
            </label></li>
            {options.checkOnOffA && (
